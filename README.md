...
Un dueño de mascota se ha sentido lo convencido por nuestras estrategias de marketing y por lo tanto ha descargado y se ha registrado en la app de TPet

![WhatsApp Image 2024-09-28 at 9 22 30 PM (1)](https://github.com/user-attachments/assets/16c8c1a0-9971-447e-98ba-34ace57c117e)

Decide que agendara una cita virtual y ve algunas opciones de veterinarios, en donde puede ver el precio, la calificacion, el logo y una pequeña descripcion de cada veterinaria

![WhatsApp Image 2024-09-28 at 9 22 30 PM (2)](https://github.com/user-attachments/assets/3fed88c3-5a11-4806-8f3b-48e5568de746)

Decide que agendara una cita con el veterinario mas barato y consulta los horarios disponibles 
...
4) Pantalla usuario y mascotas 
    - ¿Qué debe suceder?
    
      En esta pantalla se debe mostrar la información del usuario y sus mascotas. Para el usuario, se debe mostrar su nombre, correo electrónico y número de teléfono. Para cada mascota, se debe mostrar su nombre, especie, raza y una foto. Además, se debe proporcionar un botón para agregar una nueva mascota y otro para editar la información del usuario. La barra de navegación y el encabezado forman parte de todas las pantallas, por lo que de igual manera se encuentran presentes.

    - ¿Qué acciones se pueden realizar?

      - **Editar información del usuario:** Permite al usuario modificar su nombre, correo electrónico y número de teléfono.
...
5) Pantalla notificaciones
    - ¿Qué debe suceder?
       ...
       Se enlistan todas las notificaciones recibidas a la cuenta del usuario. 
...
![pantallaNotificaciones](https://github.com/user-attachments/assets/581cf143-9460-4101-a8c8-c92d772bcb43)


6) Pantalla cita finalizada
    - ¿Qué debe suceder?

      En esta pantalla se debe de mostrar las notas tomadas por IA y tambien los medicamentos recomendados por el veterinario, en donde tambien podra comprarlos.
...
![imagenCitaFinalizada1](https://github.com/user-attachments/assets/b805c2ff-c79f-4147-b92b-bc158574bdd7)
![imagenCitaFinalizada2](https://github.com/user-attachments/assets/512d72da-ae9c-459b-862b-ed02775b2b88)
![imagenCitaFinalizada3](https://github.com/user-attachments/assets/1f061924-71bb-4610-b1e9-454ced7af585)
